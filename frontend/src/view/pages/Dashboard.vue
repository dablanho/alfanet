<template>
    <div>
        ...
        <div class="row" v-if="isAuthenticated">
            ...
            <div class="col-xxl-6">
                <AracStatsList></AracStatsList>
            </div>
            <div class="col-xxl-6">
                <SoforStatsList></SoforStatsList>
            </div>
            <!--<div class="col-xxl-4">
...
import AracStatsList from "@/view/content/widgets/list/AracStatsList";
import SoforStatsList from "@/view/content/widgets/list/SoforStatsList";
